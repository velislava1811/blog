...
const footerNavigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/velislavamihaylova/',
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <Link href="/admin" className="text-sm/6 font-semibold ">
      ...
      <footer className="mt-16 sm:mt-32">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-600 dark:text-gray-300">
            &copy; {new Date().getFullYear()} Your Content by Ava, All rights reserved.
          </p>
        </div>
      </footer>
    </div>
